...
export const SAFE_ZONE_PX = Math.round(SAFE_ZONE_MM * MM_TO_PX); // 11px
...
export const CONTENT_PADDING_V_BOTTOM = 8;

/** Vnější mezera bílé písanky od vnitřku oblasti obsahu — všechy strany stejně (editor / tisk / freeform). */
export const PISANKA_PAGE_OUTER_INSET_PX = 15;
 ...
 * 15 mm) already exceed the configured safe zone, so the normal padding is fine.
 */
