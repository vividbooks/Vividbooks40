...
import { Plus, X, LayoutTemplate, Columns, Key, Eye, EyeOff, Presentation, ArrowRight, Loader2 } from 'lucide-react';
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2.5 px-3 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2 ${
                (worksheet.metadata.columns || 1) === 1
