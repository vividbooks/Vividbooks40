...
export function DocumentationLayout({ theme, toggleTheme }: DocumentationLayoutProps) {
  ...
  const handleCopyAndEdit = () => {
    ...
    try {
      ...
      // Save document content to vivid-doc-${id}
      const docData = {
        id: newDocId,
        title: page.title,
        content: page.content || '',
    ...
    >
      ...
      <div className="flex">
        ...
        <main 
          ...
          style={{ marginRight: showTeachMeChat || showSharePanel || showDocSharePanel ? '360px' : '0' }}
        >
          ...
          <div className="bg-background px-4 pt-5 pb-2 print:hidden">
            {showTeachMeChat ? (
              ...
              <div className="flex items-center gap-1">
                ...
                {/* Hide search when viewing a document */}
                {!slug && !(isMyContent && myContentId) && (
                  <button
          ...
          `}>
            ...
            ) : activeCategory === 'knihovna-vividbooks' && (!slug || slug === 'introduction') ? (
              /* Welcome iframe for library intro */
              <div className="w-full" style={{ height: 'calc(100vh - 50px)', margin: 0, padding: 0 }}>
                <iframe 
                  src="https://www.vividbooks.com/app-uvod"
