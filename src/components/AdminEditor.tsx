...
import { ArrowLeft, Save, Settings, ChevronDown, Undo, Redo, Eye, Menu, CheckCircle2, PanelLeft, Plus, Trash2, LogOut, Brain, Loader2, User, GraduationCap, ExternalLink, BookOpen, BarChart3 } from 'lucide-react';
...
export function AdminEditor({ theme, toggleTheme, onLogout }: AdminEditorProps) {
  ...
  return (
    <div className="min-h-screen flex relative" style={{ backgroundColor: '#EFF1F8' }}>
      ...
      {/* Sidebar */}
      <div 
        className={`${sidebarOpen ? 'w-[320px]' : 'w-0'} transition-all duration-300 overflow-y-auto flex-shrink-0`}
      >
        <AdminSidebar
          key={sidebarKey}
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  title={sidebarOpen ? "Skrýt menu" : "Zobrazit menu"}
                >
