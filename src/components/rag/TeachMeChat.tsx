...
const MODELS = [
  { id: 'gemini-3-pro', label: 'Gemini 3.1 Pro 🧠', badge: 'Nejlepší' },
...
Začneme jednoduše - řekni mi, co už o tomto tématu víš? Nebo se můžeš rovnou zeptat na cokoliv, čemu nerozumíš. 😊`,
  ...
  const handleSubmit = useCallback(async (e?: React.FormEvent, customMessage?: string) => {
    ...
    try {
      ...
      // Všechny modely nyní používají bezpečné Edge Function proxy
...
Odpovídej česky! 😊`;
      ...
      // Převést historii na messages formát pro proxy
      const chatMessages = [
      ...
      // Použít bezpečnou proxy pro všechny modely
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-gray-400 mt-1">
                        {m.id === 'gemini-3-flash' && 'Nejnovější Google AI - Pro inteligence, Flash rychlost'}
                        {m.id === 'gemini-2.5-flash' && 'Google AI - rychlý a spolehlivý'}
