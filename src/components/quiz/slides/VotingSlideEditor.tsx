  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-sky-500 to-cyan-500 p-4">
        ...
        <h2 className="text-white font-bold text-lg">Anketa s grafem</h2>
      </div>
        ...
        {slide.media?.url ? (
          ...
          <div className="mt-4 space-y-2">
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 outline-none text-sm"
            />
