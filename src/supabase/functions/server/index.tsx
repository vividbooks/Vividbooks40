...
app.post("/make-server-46c8107b/pages", async (c) => {
  try {
    ...
    const { slug, title, content, description, icon, documentType, featuredMedia, sectionImages, parentId, order, category, externalUrl, legacyIds, legacyMetadata, worksheetData } = await c.req.json();
    ...
    const page = {
      ...
      worksheetData: worksheetData || null, // For imported worksheets with links
      category: categoryKey,
      parentId: parentId || null,
      order: order || 0,
      legacyIds: legacyIds || null,
