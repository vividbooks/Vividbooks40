...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (isGemini) {
      ...
      // Note: thinking_level for Gemini 3 Flash will be added when API supports it
      // Currently not available in REST API (December 2025)
      ...
      // Note: gemini-3-flash-preview bude dostupný, až Google oficiálně uvolní API
      ...
      if (model.includes('2.0')) {
        ...
        // Default to latest stable (2.5 flash)
        geminiModel = 'gemini-2.5-flash'
      }
